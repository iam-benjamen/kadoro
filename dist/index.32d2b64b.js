...
var _deleteTaskJs = require("./delete_task.js");
var _deleteTaskJsDefault = parcelHelpers.interopDefault(_deleteTaskJs);
var _monitorJs = require("./monitor.js");
var _monitorJsDefault = parcelHelpers.interopDefault(_monitorJs);
var _handleFormJs = require("./handle_form.js");
var _handleFormJsDefault = parcelHelpers.interopDefault(_handleFormJs);
// Add Buttons
...
function outputData() {
    containers.forEach((container)=>{
        ...
        if (!content || content[0] === "") container.innerHTML = ` <div class="no_task">No tasks here</div>`;
        ...
        (0, _monitorJsDefault.default)();
        (0, _deleteTaskJsDefault.default)(content);
    });
}
...
//Form operations
(0, _handleFormJsDefault.default)(current_form, current_field, currentValue, inputCurrent, currentContainer);
(0, _handleFormJsDefault.default)(ongoing_form, ongoing_field, ongoingValue, inputOngoing, ongoingContainer);
(0, _handleFormJsDefault.default)(completed_form, completed_field, completedValue, inputCompleted, completedContainer);
...
const handleAddClick = (element, input)=>{
    element.addEventListener("click", ()=>{
        ...
        current_display == "none" ? input.style.display = "block" : input.style.display = "none";
...
handleAddClick(addBtnCompleted, inputCompleted); //Approach
 // 1. Implement CRUD DONE
 // 2. Data Storage DONE
 // 3. Implement Drag and Drop DONE
 // 4. Auth & store

},{"./delete_task.js":"cQIo1","./monitor.js":"543z1","./handle_form.js":"dnlwm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cQIo1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _updateContentJs = require("./update_content.js");
var _updateContentJsDefault = parcelHelpers.interopDefault(_updateContentJs);
var _monitorJs = require("./monitor.js");
var _monitorJsDefault = parcelHelpers.interopDefault(_monitorJs);
...
function deleteTasks(content) {
    ...
    deleteIcons.forEach((icon)=>{
        icon.addEventListener("click", function() {
            ...
            (0, _updateContentJsDefault.default)();
            (0, _monitorJsDefault.default)();
        });
    });
}
...
},{"./update_content.js":"jni2D","./monitor.js":"543z1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jni2D":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _deleteTaskJs = require("./delete_task.js");
var _deleteTaskJsDefault = parcelHelpers.interopDefault(_deleteTaskJs);
var _dragDropJs = require("./drag_drop.js");
var _dragDropJsDefault = parcelHelpers.interopDefault(_dragDropJs);
var _monitorJs = require("./monitor.js");
var _monitorJsDefault = parcelHelpers.interopDefault(_monitorJs);
...
function updateContent() {
    ...
    const completed_tasks = document.querySelector("#completed_container").children;
    let currentContent = [];
    let ongoingContent = [];
    ...
    collection.forEach((array)=>{
        array[0].forEach((item)=>{
            if (item.classList.contains("no_task")) saveToLocalStorage(item, [
                array[1]
            ]);
            if (!item.classList.contains("no_task")) {
                const value = item.textContent.replace("drag_handle", "").replace("delete", "").trim();
                array[1].push(value);
                saveToLocalStorage(item, [
                    array[1]
                ]);
                (0, _deleteTaskJsDefault.default)(array[1]);
            }
        });
    });
    (0, _monitorJsDefault.default)();
...
function saveToLocalStorage(item, data) {
    if (item.parentElement.id === "current_container") localStorage.setItem("current", data);
    if (item.parentElement.id === "ongoing_container") localStorage.setItem("ongoing", data);
    if (item.parentElement.id === "completed_container") localStorage.setItem("completed", data);
}
exports.default = updateContent;

},{"./delete_task.js":"cQIo1","./drag_drop.js":"cMYa0","./monitor.js":"543z1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cMYa0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _monitorJs = require("./monitor.js");
var _monitorJsDefault = parcelHelpers.interopDefault(_monitorJs);
...
function dragDrop(tasks) {
    ...
    containers.forEach((container)=>{
        container.addEventListener("dragover", (e)=>{
            ...
            if (afterElement === null || afterElement === undefined) container.appendChild(draggable);
...
},{"./monitor.js":"543z1","./update_content.js":"jni2D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"543z1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _dragDropJs = require("./drag_drop.js");
var _dragDropJsDefault = parcelHelpers.interopDefault(_dragDropJs);
function monitorContainer() {
    ...
    const containers = document.querySelectorAll(".container-content");
    containers.forEach((container)=>{
        if (container.children.length <= 1) container.children[0].style.display = "block";
        else [
            ...container.children
        ].forEach((child)=>{
            if (child.classList.contains("no_task")) child.style.display = "none";
        });
    });
    tasks.forEach((item)=>{
        ...
        //Some color effects
        if (parent.id === "current_container") item.style.border = "2px solid orange";
        if (parent.id === "ongoing_container") item.style.border = "2px solid yellow";
        if (parent.id === "completed_container") item.style.border = "2px solid green";
    });
    (0, _dragDropJsDefault.default)(tasks);
}
exports.default = monitorContainer;

},{"./drag_drop.js":"cMYa0","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}],"dnlwm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _monitorJs = require("./monitor.js");
var _monitorJsDefault = parcelHelpers.interopDefault(_monitorJs);
...
exports.default = handleFormOperations;

},{"./monitor.js":"543z1","./update_content.js":"jni2D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dhFGg","f2QDv"], "f2QDv", "parcelRequiref27e")

//# sourceMappingURL=index.32d2b64b.js.map
